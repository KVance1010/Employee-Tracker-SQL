const allQueries = {
	...
	deleteRoleQuery: [
		'SELECT title AS name, id FROM employee_role',
		'DELETE FROM employee_role WHERE id = ?',
	],
	deleteEmployeeQuery: [
